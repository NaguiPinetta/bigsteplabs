...
('iiiiiiii-iiii-iiii-iiii-iiiiiiiiiiii', 'Introduction Tutor', 'An AI tutor specialized in helping students understand BigStepLabs platform basics', 
...
('eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee', 'iiiiiiii-iiii-iiii-iiii-iiiiiiiiiiii', true, NOW()),
('ffffffff-ffff-ffff-ffff-ffffffffffff', 'iiiiiiii-iiii-iiii-iiii-iiiiiiiiiiii', true, NOW()); 